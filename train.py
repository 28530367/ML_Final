...
def train():
    ...
    # 資料路徑
    train_img_dir = f'/media/disk2/HSW/MachineLearning/Final_project_test/train_1~20/imgs'
    train_mask_dir = f'/media/disk2/HSW/MachineLearning/Final_project_test/train_1~20/masks'
    ...
    for epoch in range(1, epochs+1):
        ...
        if epoch % 10 == 0:
            # 儲存訓練完成的模型
            torch.save(model.state_dict(), f"/media/disk2/HSW/MachineLearning/Final_project_test/train-test_output/model/unet_segmentation_{id}.pth")
            print("模型已儲存。")
            ...
            file_path = f"/media/disk2/HSW/MachineLearning/Final_project_test/train-test_output/model/unet_segmentation_{id}.txt"
