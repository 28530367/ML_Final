...
# 定義資料夾路徑
input_dir = "/media/disk2/HSW/MachineLearning/Final_project_test/convert/train_original_1~20"  # 替換為您的主資料夾路徑
output_dir = "/media/disk2/HSW/MachineLearning/Final_project_test/train_1~20/masks"  # 保存圖片的資料夾名稱
record_file = "/media/disk2/HSW/MachineLearning/Final_project_test/convert/train_masks-processed.txt" # 記錄處理過檔案的路徑
