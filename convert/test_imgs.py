...
# 定義資料夾路徑
input_dir = "/media/disk2/HSW/MachineLearning/Final_project_test/convert/test_original"  # 替換為您的主資料夾路徑
output_dir = "/media/disk2/HSW/MachineLearning/Final_project_test/test/imgs"  # 保存圖片的資料夾名稱
